...
Run: `dotnet test src/WinformsMVP.Samples.Tests/WinformsMVP.Samples.Tests.csproj --filter "FullyQualifiedName~ObjectClonerTests"`
...
Run: `dotnet test src/WinformsMVP.Samples.Tests/WinformsMVP.Samples.Tests.csproj --filter "FullyQualifiedName~ObjectComparerTests"`
...
Run: `dotnet test src/WinformsMVP.Samples.Tests/WinformsMVP.Samples.Tests.csproj --filter "FullyQualifiedName~ChangeTrackerHookTests"`
...
Run: `dotnet test src/WinformsMVP.Samples.Tests/WinformsMVP.Samples.Tests.csproj --filter "FullyQualifiedName~ChangeTrackerTests"`
